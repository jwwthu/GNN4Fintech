...
* Ye J, Zhao J, Ye K, et al. <b>Multi-Graph Convolutional Network for Relationship-Driven Stock Movement Prediction[C]</b>//2020 25th International Conference on Pattern Recognition (ICPR). IEEE, 2021: 6702-6709. [Link](https://ieeexplore.ieee.org/document/9412695) [Code](https://github.com/start2020/Multi-GCGRU)
...
## 2020
### Conference
* Alarab I, Prakoonwit S, Nacer M I. <b>Competence of graph convolutional networks for anti-money laundering in bitcoin blockchain[C]</b>//Proceedings of the 2020 5th International Conference on Machine Learning Technologies. 2020: 23-27. [Link](https://dl.acm.org/doi/abs/10.1145/3409073.3409080)
...
* Hu Y, Seneviratne S, Thilakarathna K, et al. <b>Characterizing and detecting money laundering activities on the bitcoin network[J]</b>. arXiv preprint arXiv:1912.12060, 2019. [Link](https://arxiv.org/abs/1912.12060v1)

# Credit Scoring
## 2020
### Conference
* Sukharev I, Shumovskaia V, Fedyanin K, et al. <b>EWS-GCN: Edge Weight-Shared Graph Convolutional Network for Transactional Banking Data[C]</b>//2020 IEEE International Conference on Data Mining (ICDM). IEEE, 2020: 1268-1273. [Link](https://ieeexplore.ieee.org/abstract/document/9338368/)

# Default Prediction
## 2021
### Journal
* Chi M, Hongyan S, Shaofan W, et al. <b>Bond Default Prediction Based on Deep Learning and Knowledge Graph Technology[J]</b>. IEEE Access, 2021, 9: 12750-12761. [Link](https://ieeexplore.ieee.org/abstract/document/9326405/)
* Lee J W, Lee W K, Sohn S Y. <b>Graph convolutional network-based credit default prediction utilizing three types of virtual distances among borrowers[J]</b>. Expert Systems with Applications, 2021, 168: 114411. [Link](https://www.sciencedirect.com/science/article/pii/S0957417420310794)
...
## 2020
### Conference
* Yang S, Zhang Z, Zhou J, et al. <b>Financial Risk Analysis for SMEs with Graph-based Supply Chain Mining[C]</b>//IJCAI. 2020: 4661-4667. [Link](https://www.ijcai.org/Proceedings/2020/0643.pdf)

# Fraud Detection
## 2021
### Conference
* Ren Y, Zhu H, Zhang J, et al. <b>Ensemfdet: An ensemble approach to fraud detection based on bipartite graph[C]</b>//2021 IEEE 37th International Conference on Data Engineering (ICDE). IEEE, 2021: 2039-2044. [Link](https://ieeexplore.ieee.org/abstract/document/9458705/)

## 2020
### Journal
* Kurshan E, Shen H. <b>Graph Computing for Financial Crime and Fraud Detection: Trends, Challenges and Outlook[J]</b>. International Journal of Semantic Computing, 2020, 14(04): 565-589. [Link](https://www.worldscientific.com/doi/abs/10.1142/S1793351X20300022)

### Conference
* Dou Y, Liu Z, Sun L, et al. <b>Enhancing graph neural network-based fraud detectors against camouflaged fraudsters[C]</b>//Proceedings of the 29th ACM International Conference on Information & Knowledge Management. 2020: 315-324. [Link](https://dl.acm.org/doi/abs/10.1145/3340531.3411903) [Code](https://github.com/YingtongDou/CARE-GNN)
* Kurshan E, Shen H, Yu H. <b>Financial Crime & Fraud Detection Using Graph Computing: Application Considerations & Outlook[C]</b>//2020 Second International Conference on Transdisciplinary AI (TransAI). IEEE, 2020: 125-130. [Link](https://ieeexplore.ieee.org/abstract/document/9253149/)
* Zhu Y N, Luo X, Li Y F, et al. <b>Heterogeneous Mini-Graph Neural Network and Its Application to Fraud Invitation Detection[C]</b>//2020 IEEE International Conference on Data Mining (ICDM). IEEE, 2020: 891-899. [Link](https://ieeexplore.ieee.org/abstract/document/9338325/) [Code](https://github.com/iqiyi/HMGNN)

### Preprint
* Rao S X, Zhang S, Han Z, et al. <b>xFraud: Explainable Fraud Transaction Detection on Heterogeneous Graphs[J]</b>. arXiv preprint arXiv:2011.12193, 2020. [Link](https://arxiv.org/abs/2011.12193)